...
import { X, User as UserIcon, Mail, Phone, AlignLeft, Loader2 } from "lucide-react";
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-[rgba(0,0,0,0.2)] border border-[rgba(72,213,255,0.12)] text-sm text-[var(--text-primary)] focus:border-[rgba(72,213,255,0.3)] focus:outline-none transition-colors min-h-[80px] resize-none pt-2.5"
                                        />
                                    </div>
                                </div>
                            </div>
