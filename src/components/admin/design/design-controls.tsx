    ...
    return (
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="space-y-4 rounded-2xl border border-[rgba(110,211,225,0.2)] bg-[rgba(6,20,27,0.55)]/80 p-6">
                <h3 className="text-sm font-semibold text-[color:var(--color-turkish-blue-200)] uppercase tracking-[0.25em]">Renkler</h3>
            ...
            <div className="space-y-4 rounded-2xl border border-[rgba(110,211,225,0.2)] bg-[rgba(6,20,27,0.55)]/80 p-6">
                <h3 className="text-sm font-semibold text-[color:var(--color-turkish-blue-200)] uppercase tracking-[0.25em]">Tipografi & Köşeler</h3>
            ...
            <div className="col-span-full rounded-2xl border border-[rgba(110,211,225,0.2)] bg-[rgba(6,20,27,0.55)]/80 p-6">
                <h3 className="text-sm font-semibold text-[color:var(--color-turkish-blue-200)] uppercase tracking-[0.25em] mb-3">Önizleme</h3>
                <div className="rounded-xl border p-6" style={{
                    ...
                    <h4 style={{ color: settings.primary }} className="text-xl mb-2">Tengra Studio</h4>
                    <p className="text-sm opacity-80">Canlı önizleme alanı — seçtiğiniz renkler, yazı tipleri ve köşe yuvarlaklıkları burada uygulanır.</p>
                    <div className="mt-4 flex gap-3">
                        <button className="rounded-full px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em]" style={{ background: settings.primary, color: "#000" }}>Birincil</button>
                        <button className="rounded-full px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] border" style={{ borderColor: settings.primary, color: settings.primary }}>İkincil</button>
                    </div>
                </div>
            </div>
        </div>
