...
export function CommandMenu() {
    ...
    // const t = useTranslations("CommandMenu"); // Assuming keys exist later, using hardcoded for now
            ...
            <DialogContent className="fixed left-1/2 top-[20%] -translate-x-1/2 p-0 shadow-2xl bg-[rgba(15,25,35,0.95)] backdrop-blur-xl border border-[rgba(255,255,255,0.1)] rounded-xl overflow-hidden w-full max-w-lg z-50">
                ...
                <Command className="w-full bg-transparent">
                    ...
                    <Command.List className="max-h-[300px] overflow-y-auto overflow-x-hidden p-2">
                        ...
                        <Command.Group heading="Navigation" className="px-2 py-1.5 text-xs font-medium text-[rgba(255,255,255,0.5)]">
                            <Command.Item
              ...
              >
                ...
                <span>Projects</span>
                        ...
                        <Command.Group heading="Settings" className="px-2 py-1.5 text-xs font-medium text-[rgba(255,255,255,0.5)]">
                            <Command.Item
                        ...
                        <Command.Group heading="Theme" className="px-2 py-1.5 text-xs font-medium text-[rgba(255,255,255,0.5)]">
                            <Command.Item
